...
type LoadedResourceCollection<T extends ApiResource> = {
    isLoading: false
    data: T[]
...
export type ManagedResourceCollection<T extends ApiResource, TLoading = boolean> = ResourceLoader & (TLoading extends false ? UnloadedResource : LoadedResourceCollection<T>)
