 ...
 export default function RecipeListSkeleton(props) {
    return (
        <div className={
            ...
            <div className="rounded-xl h-36 w-full object-cover bg-gray-400 dark:bg-gray-700" />
            <div className="rounded-xl h-36 w-full object-cover bg-gray-400/75 dark:bg-gray-800/75" />
            <div className="rounded-xl h-36 w-full object-cover bg-gray-400/50 dark:bg-gray-700/50" />
            <div className="rounded-xl h-36 w-full object-cover bg-gray-400/75 dark:bg-gray-800/75" />
            <div className="rounded-xl h-36 w-full object-cover bg-gray-400 dark:bg-gray-700" />
            <div className="rounded-xl h-36 w-full object-cover bg-gray-400 dark:bg-gray-700" />
            <div className="rounded-xl h-36 w-full object-cover bg-gray-400/75 dark:bg-gray-800/75" />
