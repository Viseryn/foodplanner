 ...
 * @param props.style Optional: Additional styling classes for the <li> element.
 * @param props.icon Optional: The icon of the menu button. Default is 'menu'.
 */
export default function SidebarDrawerButton({ isDrawerVisible, setDrawerVisible, style = '', icon = 'menu' }: {
    ...
    return <li className={`xl:w-min ${style}`}>
        <div 
