/**************************************************
 * ./assets/components/ui/AddIngredientWidget.tsx *
 **************************************************/

import React from 'react'

/**
 * An input widget component for adding a new item to a list. The input value of the widget is stored 
 * in the state variable inputValue of the parent component. When using this component one must pass 
 * a enter key down event handler that takes the (trimmed) inputValue as parameter.
 * 
 * @component
 * @param props
 ...
 * @param props.placeholder Optional: The placeholder text of the widget. Default is 'Tippe eine Zutat ein ...'.
 */
 export default function AddIngredientWidget({ 
    inputValue, 
    setInputValue, 
    handleEnterKeyDown, 
    ...
    handleEnterKeyDown: (trimmedInputValue: string) => void
    placeholder?: string
}): JSX.Element {
    /**
     * Handles all keyboard presses. On enter presses the function checks whether the inputValue is 
     * more than whitespace, and if yes, will call the argument function handleEnterKeyDown from the 
     * parent component with the trimmed inputValue as argument.
     * 
    ...
    // Render AddIngredientWidget
    return <div className="rounded-full font-semibold bg-secondary-200 dark:bg-secondary-dark-200 h-14 flex items-center pl-6 pr-4">
