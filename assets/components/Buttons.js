...
function buttonStyle(style, elevated = false) {
    ...
    let baseStyle = 'rounded-full h-12 px-4 font-semibold text-md transition duration-300 flex items-center active:scale-95';
    let primaryStyle = ' text-white dark:text-blue-300 bg-blue-500 dark:bg-[#232325] hover:bg-blue-700 dark:hover:bg-[#232325]/[.6] active:bg-blue-500';
    let inverseStyle = ' text-blue-600 dark:text-blue-300 bg-gray-100 dark:bg-transparent hover:bg-gray-200 dark:hover:bg-[#232325] active:text-blue-800';
    let transparentStyle = ' text-blue-600 dark:text-blue-300 hover:bg-gray-100 dark:hover:bg-[#232325] active:bg-gray-200 active:text-blue-800';
